...
from .message_handlers.callback_handler import increment_cart_handler,precheckout_handler,successful_payment_callback, decrement_cart_handler, picckup_handler, cancel_order_handler
...
conv_handler = ConversationHandler(
    ...
    states={
        ...
        DELIVERY_TYPE: [admin_handler,pickup_callback_handler,cancel_ord_handler],
        BOXBERRY: [admin_handler ],
